...
/**
 * Created by Cagrosso on 6/14/16.
 */
/*
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // Third step (Weather): Insert contentValues into dataabase and get a row Id back
        long weatherRowId = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, weatherValues);
        assertTrue(weatherRowId != -1);

        // Fourth step: Query the database and recieve a Cursor back
    ...
    public long insertLocation() {
        ...
        long locationRowId;
        locationRowId = sqLiteDatabase.insert(WeatherContract.LocationEntry.TABLE_NAME, null, contentValues);
